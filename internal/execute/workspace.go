...
func materializeFiles(ws Workspace, req *model.RunRequest) (primaryPath string, lang string, err error) {
	...
	for i, b := range req.Binaries {
		...
		for _, ext := range []string{".bas", ".graphql", ".lean", ".agda", ".dfy", ".tla", ".mlw", ".fst", ".fsti", ".als", ".lisp", ".lsp", ".acl2", ".k", ".st", ".gs", ".sml", ".ts", ".tsx", ".mts", ".cts", ".js", ".jsx", ".mjs", ".cjs", ".sql", ".bqn", ".apl", ".ijs", ".ua", ".janet", ".coffee", ".raku", ".rakumod", ".p6", ".pl6", ".sed", ".bc", ".bef", ".bf93", ".lol", ".ape", ".fs", ".fth", ".4th", ".a68", ".sh", ".zsh", ".fish", ".ps1"} {
	...
	if entryPointPath != "" {
		...
		if (lang == "binary" || lang == "go-binary" || lang == "mojo-binary" || lang == "pony-binary" || lang == "chapel-binary" || lang == "chicken-scheme" || lang == "c3") && !submittedExec[entryPointPath] {
