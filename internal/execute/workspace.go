...
func materializeFiles(ws Workspace, req *model.RunRequest) (primaryPath string, lang string, err error) {
	...
	case "haxe":
		return primaryPath, lang, nil
	case "vb6", "carbon", "graphql", "lean4", "agda", "dafny", "tla", "why3", "smalltalk", "golfscript", "coffeescript", "raku", "sed", "bc", "befunge", "lolcode", "forth", "deno", "kotlin-jvm", "duckdb", "bqn", "apl", "j", "uiua", "janet":
		if sourcePath == "" {
