...
func materializeFiles(ws Workspace, req *model.RunRequest) (primaryPath string, lang string, err error) {
	...
	if entryPointPath != "" {
		...
		if (lang == "binary" || lang == "go-binary" || lang == "c3") && !submittedExec[entryPointPath] {
	...
	switch lang {
	case "binary", "go-binary", "c3", "javascript", "ruby", "php", "lua", "perl", "uhmlang", "csharp", "fsharp", "vbnet", "text", "ocaml", "elixir", "sqlite", "julia", "r", "prolog", "lisp", "whitespace", "brainfuck", "wasm", "aheui", "apecode", "cuda-ocelot":
	...
	case "haxe":
		return primaryPath, lang, nil
	case "vb6", "carbon", "graphql", "lean4", "agda", "dafny", "tla", "why3", "fstar", "alloy", "acl2", "kframework", "smalltalk", "golfscript", "coffeescript", "raku", "sed", "bc", "befunge", "lolcode", "forth", "deno", "kotlin-jvm", "duckdb", "bqn", "apl", "j", "uiua", "janet":
		if sourcePath == "" {
