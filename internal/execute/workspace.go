...
func materializeFiles(ws Workspace, req *model.RunRequest) (primaryPath string, lang string, err error) {
	...
	for i, b := range req.Binaries {
		...
		for _, ext := range []string{".bas", ".graphql", ".lean", ".agda", ".dfy", ".tla", ".mlw", ".fst", ".fsti", ".als", ".lisp", ".lsp", ".acl2", ".k", ".st", ".gs", ".ts", ".js", ".sql", ".bqn", ".apl", ".ijs", ".ua", ".janet", ".coffee", ".raku", ".rakumod", ".p6", ".pl6", ".sed", ".bc", ".bef", ".bf93", ".lol", ".ape", ".fs", ".fth", ".4th", ".a68", ".sh", ".ps1"} {
	...
	switch lang {
	case "binary", "go-binary", "mojo-binary", "pony-binary", "chapel-binary", "c3", "javascript", "ruby", "php", "lua", "perl", "uhmlang", "csharp", "fsharp", "vbnet", "text", "ocaml", "elixir", "sqlite", "julia", "r", "prolog", "lisp", "whitespace", "brainfuck", "wasm", "assemblyscript", "factor", "aheui", "apecode", "cuda-ocelot":
		return primaryPath, lang, nil
	case "bash", "posix-sh", "powershell":
		if sourcePath == "" {
