...
func TestRepositoryCatalogStrengthensNewLanguageSmokeCoverage(t *testing.T) {
	...
	tests := map[string][]string{
		...
		"coffeescript":  {"coffeescript", "coffee --compile --bare --output . Main.coffee"},
		...
		"objective-c":   {"clang -x objective-c -O2 -pipe Main.m -o Main -lobjc", "libobjc-14-dev"},
		"objective-cpp": {"clang++ -x objective-c++ -O2 -pipe Main.mm -o Main -lobjc", "libobjc-14-dev"},
