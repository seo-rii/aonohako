...
func Build(cfg config.Config) (Runner, error) {
	...
	case platform.ExecutionTransportEmbedded:
		...
		return &Service{runtimeTuning: cfg.Execution.RuntimeTuning.WithSafeDefaults(), runtimeTuningProfiles: profiles, cgroupParentDir: cfg.Execution.Cgroup.ParentDir}, nil
