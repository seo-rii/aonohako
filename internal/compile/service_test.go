...
func TestResolveProfileSupportsNewLanguages(t *testing.T) {
	tests := map[string]struct {
		...
		"chez-scheme":   {compileKind: "chez-scheme", runLang: "chez-scheme"},
		"chezscheme":    {compileKind: "chez-scheme", runLang: "chez-scheme"},
		"guile":         {compileKind: "guile", runLang: "guile"},
		"guile-3.0":     {compileKind: "guile", runLang: "guile"},
		...
		"shell":         {compileKind: "shell", runLang: "bash"},
