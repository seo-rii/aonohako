...
| `prlimit --fsize` | Max file size (workspace_bytes when set, otherwise 128 MB); .NET disables this rlimit for CoreCLR/F# compatibility and relies on workspace accounting |
