...
report_compile_option "plain" "C: gcc -O2 -Wall -lm --static -DONLINE_JUDGE -std=c11; C++: g++ -O2 -Wall -lm --static -pipe -DONLINE_JUDGE -std=c++17; text: pass-through"
...
report_compile_option "deno" "deno check"
report_compile_option "haxe" "haxe -main Main -neko <target>.n"
report_compile_option "graphql" "pass-through .graphql artifacts"
report_compile_option "asm" "gcc -nostdlib -static -no-pie"
report_compile_option "nasm" "nasm -felf64 plus gcc -nostdlib -static -no-pie"
report_compile_option "objective-c" "clang -x objective-c -O2 -pipe -lobjc"
report_compile_option "objective-cpp" "clang++ -x objective-c++ -O2 -pipe -lobjc"
report_compile_option "go" "go build -o <target>"
report_compile_option "rust" "rustc --edition 2018 -O -o <target>"
report_compile_option "zig" "zig build-exe -O ReleaseSafe"
report_compile_option "pascal" "fpc -O2 -Xs"
report_compile_option "nim" "nim c -d:release --opt:speed"
...
report_compile_option "cython" "cython3 --embed -3 plus gcc -O2 -pipe"
report_compile_option "d" "ldc2 -O3 -release"
report_compile_option "fortran" "gfortran -O2 -pipe -static"
report_compile_option "crystal" "crystal build --release --no-debug"
report_compile_option "vlang" "v -o <target>"
report_compile_option "odin" "odin build . -out:<target>"
report_compile_option "c3" "c3c compile -O2"
report_compile_option "hare" "hare build -o <target>"
report_compile_option "mojo" "mojo build -o <target>"
report_compile_option "kotlin" "kotlinc-native -opt -o <target>"
...
report_compile_option "swift" "swiftc -O"
...
report_compile_option "vbnet" "dotnet publish --configuration Release -p:UseAppHost=false"
report_compile_option "csharp" "dotnet publish --configuration Release -p:UseAppHost=false"
report_compile_option "fsharp" "dotnet publish --configuration Release -p:UseAppHost=false"
report_compile_option "vb6" "pass-through VB6 source artifacts"
report_compile_option "freebasic" "fbc -x <target>"
report_compile_option "classic-basic" "fbc -lang qb -x <target>"
report_compile_option "qbasic" "fbc -lang qb -x <target>"
...
report_compile_option "verilog" "iverilog -g2012 -o <target>.vvp"
report_compile_option "systemverilog" "iverilog -g2012 -o <target>.vvp"
report_compile_option "r" "Rscript parse check"
...
report_compile_option "julia" "julia --compile=min syntax check"
...
report_compile_option "isabelle" "isabelle build -D ."
EOF
